...
public class EloServiceTest {
    ...
    private String leaderboardServiceUrl; //defined in application-test.properties in config
    ...
    @Test
    public void testFindPlayerEloHistoryForChartMoreThanOrEqualTo5() {
    ...
    @Test
    public void testFindPlayerEloHistoryForChartLesThan5() {
        int numEloHistories = 3;
        LocalDate[] dates = new LocalDate[10];
        List<EloHistoryChartDTO> expected = new ArrayList<>();
        List<EloHistory> list = new ArrayList<>();
        int elo = 1300;
    ...
    public void testUpdateMatchPlayerElo() {
        ...
        //LocalDateTime t1 = LocalDateTime.of(LocalDate.now(), LocalTime.of(0,0));
        //LocalDateTime t2 = LocalDateTime.of(LocalDate.now(), LocalTime.of(0, 0));
