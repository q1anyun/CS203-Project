...
function EditProfileDialog({ open, handleClose, playerDetails, handleDetailChange, handleFileAndImageUpload, handleSave, options, localProfilePic}) {

  return (
    <Dialog open={open} onClose={handleClose} sx={{ '& .MuiDialog-paper': { width: '80%', maxWidth: '600px' } }}>
      <DialogTitle>Edit Profile</DialogTitle>
      <DialogContent sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
        <Avatar sx={{ width: 200, height: 200, marginTop: 15 }} alt={playerDetails.firstName} src={localProfilePic} />
