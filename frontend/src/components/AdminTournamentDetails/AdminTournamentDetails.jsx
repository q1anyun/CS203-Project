...
import { Card, CardContent, Typography, Box, Divider, Grid, Avatar, Button, IconButton, Dialog, Select, MenuItem, DialogTitle, DialogContent, DialogActions } from '@mui/material';
        ...
        <Box sx={{ padding: 2 }}>
            ...
            <Box display="flex" alignItems="center" justifyContent="space-between">
                ...
                <Box display="flex" flexDirection="column">
                    ...
                    <Typography variant="body1" gutterBottom marginLeft={'20px'}>
